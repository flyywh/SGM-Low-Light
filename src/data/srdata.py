    ...
    def _load_file(self, idx):
        ...
        if self.args.ext.find('bin') >= 0:
            ...
            if self.args.ext == 'img' or self.benchmark:
                ...
                with open(f_hr, 'rb') as _f: hr = np.load(_f, encoding='bytes', allow_pickle=True)[0]['image']
                with open(f_lr, 'rb') as _f: lr = np.load(_f, encoding='bytes', allow_pickle=True)[0]['image']
